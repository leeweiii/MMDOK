...
os.environ["WANDB_API_KEY"] = '0b4b8b6bb397c2f3a9ffb38c38ef2a8a96e61832'
...
def get_parser():
    ...
    parser.add_argument("--test", action="store_true", default=False, help="specify to test model"
                                                                            "By default run.py trains a model based on config file")
    parser.add_argument("--ckpt_path", type=str, default=None, help="Checkpoint path of the desired test model")
    parser.add_argument("--random_seed", type=int, default=27, help="Random seed")  # 23 /  25,27,29
...
def main(cfg, args):
    # get datamodule
    dm = MGLRL.builder.build_data_module(cfg)

    # define lightning module
    model = MGLRL.builder.build_lightning_model(cfg, dm)
